...
const Post = ({ id, title, content, editPost, deletePost, likePost }) => {
  return (
    <>
      <div className="card card-width bg-dark">
        <section key={id}>
          ...
          <span title="like post" onClick={() => likePost()}>
            <i id="like" className="like-button fas fa-light fa-heart fa-2x ml-2 button-css" />
          </span>
        </section>
      </div>
    </>
